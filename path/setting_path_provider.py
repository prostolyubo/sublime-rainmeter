...
def get_cached_setting_path():
	...
	if os.path.exists(rainmeterpath + "Rainmeter.ini"):
		logger.log(__file__, "get_cached_settings_path", "Rainmeter.ini found in " + rainmeterpath)
		...
		if os.path.exists(os.path.join(appdata, "Rainmeter\\Rainmeter.ini")):
			logger.log(__file__, "get_cached_settings_path", "Rainmeter.ini found in " +
				 os.path.join(appdata, "Rainmeter") + "\\")
			return os.path.join(appdata, "Rainmeter") + "\\"
		else:
			logger.log(__file__, "get_cached_settings_path", "Rainmeter.ini could not be located.")
			return None